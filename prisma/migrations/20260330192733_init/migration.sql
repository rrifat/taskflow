-- CreateEnum
CREATE TYPE "TicketHistoryType" AS ENUM ('CREATED', 'UPDATED', 'MOVED', 'DELETED');
...
-- CreateIndex
CREATE INDEX "Ticket_categoryId_order_idx" ON "Ticket"("categoryId", "order");
...
-- AddForeignKey
ALTER TABLE "TicketHistory" ADD CONSTRAINT "TicketHistory_actorUserId_fkey" FOREIGN KEY ("actorUserId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
